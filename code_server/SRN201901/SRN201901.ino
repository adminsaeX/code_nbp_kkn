...
//=========================Define device ===================//
String deviceID = "SRN201901" ;// 8 digit
String projectID = "SRN1" ;// 4 digit
String api_key = "v8mp0BsKVH";
...
/////////////inverter BPD invt////////////////////////
byte ID_inverter = 57 ;
uint16_t addDcVolt = 107 ;
uint16_t addDcAmp = 112;
uint16_t addDcPower = 103  ;
uint16_t addHz = 106;
uint16_t addState = 104 ;
uint16_t addFault = 105;
uint16_t addE1 = 101;
uint16_t addE2 = 102;
uint16_t addE3 = 100;
uint16_t addSD = 0;
